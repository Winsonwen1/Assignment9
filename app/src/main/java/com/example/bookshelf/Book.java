...
public class Book implements Parcelable {
    ...
    public final static String JSON_BOOK_DURATION = "duration";

    private int id, bookDuration;
    private String title, author, coverUrl;

    public Book(int id, String title, String author, String coverUrl, int bookDuration) {
        this.id = id;
        this.title = title;
        this.author = author;
